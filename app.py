...
def add_custom_styling():
    ...
    /* Hide deploy button and menu button */
    .stDeployButton {
    ...
    header[data-testid="stHeader"] {
        background-color: #261705 !important;
    }
    ...
    body, .stApp {
        font-family: 'Quicksand', sans-serif !important;
        background-color: #33210a !important;
    }
    ...
    .stButton > button {
        ...
        border: 2px solid #33210a !important;
...
def preprocess_image(image_bytes):
    """
    Preprocess image bytes into a PIL Image.
    ...
    Raises:
        ValueError: If the image format is invalid or cannot be processed
    """
    try:
        # Log the type and length of image_bytes for debugging
        ...
        raise ValueError(f"Unable to process the uploaded image. Please ensure it's a valid image file. Error: {str(e)}")

# Example usage in a Streamlit app
def process_uploaded_image():
    """Handle image upload in Streamlit app"""
    ...
    if uploaded_file is not None:
        try:
            ...
            # Return the processed image for further use
            return image
